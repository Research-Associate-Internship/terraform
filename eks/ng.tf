resource "aws_eks_node_group" "NextGenDS-rac3-node-group" {
  ...
  subnet_ids      = ["subnet-087b37379578cd037","subnet-0aa9f30d1300a6a64"] //, module.vpc.private_subnets[1]]
  ...
  remote_access {
    ec2_ssh_key               = "bastion"
    source_security_group_ids = ["sg-0f66820510033f188"]
  }
